export const RU = {
   ...
   EuphratesRiverDesc:
      "Каждые 10% занятых рабочих, занятых производством (не транспортировкой), дают +1 Множитель Производства всем зданиям, которые не производят рабочих (максимум = количество разблокированных эпох / 2). Когда рядом с ним строится Висячий сад, Висячий сад получает +1 эффект за каждую эпоху после разблокировки Висячего сада. При обнаружении порождает воду на всех соседних плитках, на которых нет месторождений.",
   ...
   FreeThisWeekDescHTML: "<b>Каждую неделю</b> в одном из премиальных городов можно играть бесплатно. Бесплатный город на этой неделе - %{city}</b>",
   Frigate: "Фрегат",
   ...
   RamessesIIDesc: "+%{value} к Множителю Мощности Стоительства",
   ...
   Shelter: "Укрытие",
   Shenandoah: "Шенандоа",
   ShenandoahDescV2: "Здания, разблокированные в текущую эпоху, получают +2 к Множителю Производства. Двойной эффект от Дж. П. Морган",
   ...
   StatisticsBuildingsFilters: "Фильтры",
   ...
   StatisticsResourcesFilters: "Фильтры",
   ...
   TheMet: "Метрополитен",
   TheMetDesc: "После постройки создайте телепорты, которые можно использовать для перемещения зданий. Все здания в радиусе 2 клеток получают +1 к Множителю Производства, Производительности Работников и Хранилища.",
   ...
   TutorialAdvices:
      "Мы попросили опытных игроков дать совет начинающим игрокам. Вот несколько очень полезных советов, прежде чем вы погрузитесь в игру.<ol><li><b>Не улучшайте все свои здания одновременно</b>: улучшаемые здания не производят ресурсы</li><li><b>Обратите внимание на Счастье</b>: отрицательное Счастье уменьшает количество доступных рабочих и при достижении -50 Счастья, всё производство остановится</li><li><b>Не расширяйтесь слишком сильно</b>: здания требуют счастья. Перед расширением убедитесь, что у вас достаточно Счастья</li><li><b>Отдайте предпочтение хижинам, домам и апартаментам</b>: установите для них максимальный приоритет во избежание колебаний количества рабочих</li><li><b>Вы можете переродиться в любое время в главном здании</b>: ничего страшного, если вы испортили первый забег</li></ol>",
   ...
   ZigguratOfUrDesc: "Каждые 10 счастья (ограничение) дают +1 к Множителю Производства для всех зданий (максимум = количество разблокированных эпох / 2). Чудеса (включая природные) больше не дают +1 Счастья. Эффект можно отключить",
   ...
   SocialismLevel4DescHTML: "Единоразово генерирует науку, равную самой дорогой технологии <b>эпохи Мировых войн</b>",
   SocialismLevel5DescHTML: "Единоразово генерирует науку, равную самой дорогой технологии <b>эпохи Холодной войны</b>",
};
